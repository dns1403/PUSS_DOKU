...
\definecolor{errorbackground}{RGB}{252,100,100}
%\definecolor{infoforeground}{RGB}{58,135,173}
\definecolor{errorborder}{RGB}{219,100,100}
...
\NewEnviron{error}
{
    \vskip \baselineskip
    \begin{tikzpicture}
        \node[inner sep=1pt, draw=errorborder, rounded corners=0.1cm, fill=errorbackground] (box) {
            \parbox[t]{\textwidth}
            {%
                \begin{minipage}{.1\textwidth}
                    \vskip 4pt
