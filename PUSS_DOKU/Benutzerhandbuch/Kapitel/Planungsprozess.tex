...
%
\paragraph*{Klasse}
Eine Klasse besteht aus einer Menge von Schülern, die gemeinsam bestimmte Lehrveranstaltungen besuchen. 
Jede Klasse ist dabei einem bestimmten Jahrgang zugeordnet.
Eine Klasse hat immer eine feste Anzahl von Schülern und besucht eine bestimmte Menge von Lehrveranstaltungen im Laufe eines Schuljahres.
\paragraph*{Jahrgang}
Ein Jahrgang ist eine Menge von Klassen. In jedem Jahrgang müssen bestimmte Lehrveranstaltungen besucht werden. 
Diese Veranstaltungen können in bestimmten Fällen von mehreren Klassen gemeinsam besucht werden.
...
\paragraph*{Raum}
Ein Raum ist eine Ressource, die von der Schule bereitgestellt wird. Sie ist insofern notwendig für eine Veranstaltung, als dass diese ohne einen Raum nicht stattfinden kann.
%
...
Jeder Lehrveranstaltung ist genau einer Lehrperson\footnote{Es gibt seltene Ausnahmen mit mehreren Lehrpersonen pro Lehrveranstaltung.} zugeordnet. % jedoch kann ein*e Lehrer*in mehrere Lehrveranstaltungen anbieten.
...
Ein Klassenkonflikt liegt vor, wenn zwei Lehrveranstaltungsteile der selben Klasse, die von der Klasse verpflichtend belegt werden müssen, eine zeitliche Überschneidung vorweisen.
Unterschieden wird dabei noch zwischen leichten und schweren Klassenkonflikten. 
Ein schwerer Konflikt besteht, wenn die betroffene Veranstaltung eine Pflichtveranstaltung ist und es keine alternativen Termine gibt. 
%
\paragraph*{Lokales Planungstool}
Das Tool zur lokalen Planung wird in diesem Dokument hauptsächlich „lokales Planungstool“  oder „Planungstool“ genannt.\footnote{Vielen Dank an die Projektgruppe STULP für die Bereitstellung dieser Software.}
%
% \paragraph*{p2tool}
...
Die Schulleitung ermittelt auf Basis der Anmeldezahlen und der Versetzungsstatistik die Anzahl der benötigten Klassen und Kurse für das kommende Schuljahr. Auch das Angebot im Wahlpflichtbereich (WPI/WPII) oder bei Arbeitsgemeinschaften wird hier definiert. Diese Phase findet jährlich vor Beginn des neuen Schuljahres statt.

\paragraph*{Phase 3: Lehrverteilung und Wunscherfassung}
In dieser Phase geben die Lehrkräfte ihre Wünsche bzgl. Fächern, Klassenstufen und zeitlichen Verfügbarkeiten (z.~B. teilzeitbedingte freie Tage) an.
