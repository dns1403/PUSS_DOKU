...
Dieses Dokument dient als technische Spezifikation. Es richtet sich an Entwickler und System\-architekten. 
...
Diese haben bereits eine ausführliche Dokumentation zu ihrer Implementierung erstellt, auf die wir hier verweisen wollen.
...
\begin{enumerate}
    \item \textbf{Dokumentation der Quell-Daten:} Eine detaillierte Analyse der relevanten DIF-Export\-dateien aus Untis, einschließlich der Datenstrukturen, Schlüsselattribute und der semantischen Bedeutung der enthaltenen Informationen (siehe Kapitel \ref{sec:dif}).
