...
Die SQL-Funktion \texttt{ROW\_NUMBER()} erzeugt dabei einen fortlaufenden Primärschlüssel.\footnote{In in der SQL Implementierung sind Time und Hour markiert, da es diese auch als SQL Keywords gibt. Wir meinen hier die Spaltennamen, aus den Hilfstabellen, die wir für die Konstruktion des Zeitrasters benötigen.}
...
FROM (
    ...
    GROUP BY SP.Unterrichts\-nummer, SP.Fach, SP.Lehrer, SP.Tag, SP.Stunde
) AS InnerPlan
