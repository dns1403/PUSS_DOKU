...
Das erste Skript \todo{Namen entgültig festlegen} bildet die relevanten Daten aus den Untis-DIF-Textdateien in eine relationale SQLite-Datenbank (\texttt{Untis-DIF.db}) um. 
...
Das Skript verbindet sich mit beiden SQLite-Datenbanken und führt SQL-basierte Transformationen durch. 
Die Untis-Export-Datenbank wird im Folgenden mit dem SQL-Alias \texttt{dif\_data} referenziert, die Planungstool-Datenbank mit \texttt{stulp}.
