...
FROM
    ...
    AS TS;
\end{sqlbox}
\todo{Keyword Problem lösen: Time und Hour sind in der SQL-Implementierung als Spaltennamen verwendet, was zu Konflikten mit reservierten SQL-Keywords führt.}
\subsection{Plan}
...
\begin{enumerate}
    ...
    Um dies zu vermeiden, werden alle Fächer, die mit einem Unterstrich beginnen zu einer einzigen Veranstaltung zusammengefasst, die von den betroffenen Klassen gemeinsam besucht wird (siehe Pflicht \ref{SQL:Pflicht} für die Implementierung der Logik zum belegen von \_Kursen).
