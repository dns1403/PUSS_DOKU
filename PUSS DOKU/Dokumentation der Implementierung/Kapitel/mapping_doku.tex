...
\begin{enumerate}
    ...
    Um dies zu vermeiden, werden alle Fächer, die mit einem Unterstrich beginnen zu einer einzigen Veranstaltung zusammengefasst, die von den betroffenen Klassen gemeinsam besucht wird (siehe Zeile 5.6 SQL von Pflicht \ref{SQL:Pflicht} für die Implementierung der Logik zum belegen von \_Kursen).
