...
Um dennoch auf einen Blick alle relevanten Spalteneigenschaften auf einen Blick erkennen zu können, werden den Spaltennamen der Primärschlüsselattribute ein \#, den Spaltennamen der Fremdschlüsselattribute ein ($\uparrow$) vorangestellt.
...
\paragraph{Schema und Beispiel\-daten}
    ...
    \begin{table}[h]
        ...
        \begin{tabular}{|c|c|c|c|c|c|c|c|c|}
            ...
            \textbf{Notation}  & \cellcolor[HTML]{A4C2F4} PK & \cellcolor[HTML]{A4C2F4} PK & \cellcolor[HTML]{F9CB9C} 2. NF & \cellcolor[HTML]{A4C2F4} PK & \cellcolor[HTML]{B7E1CD} FK & \cellcolor[HTML]{A4C2F4} PK & \cellcolor[HTML]{A4C2F4} PK & \\ \hline
...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|c|c|c|c|}
        ...
        \textbf{Notation}  & \cellcolor[HTML]{A4C2F4} PK & \cellcolor[HTML]{A4C2F4} PK & \cellcolor[HTML]{B7E1CD} FK & \cellcolor[HTML]{A4C2F4} PK & \\ \hline
...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|c|c|c|}
        \hline
                       & \textbf{\# Name} & \textbf{Langname} & \textbf{Schul-Stufe} & \textbf{$\uparrow$ Schulform} \\ \hline\hline
...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|c|c|c|}
        \hline
                       & \textbf{\# Name} & \textbf{Langname} & \textbf{Vorname} & \textbf{Titel} \\ \hline\hline
...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|c|c|c|c|}
        \hline
                       & \textbf{\# Name} & \textbf{Langname} & \textbf{Kapazität} & \textbf{Gang 1} & \textbf{Gang 2} \\ \hline\hline
...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|c|c|}
        \hline
                       & \textbf{\# Name} & \textbf{Langname} & \textbf{$\uparrow$ Raum} \\ \hline\hline
...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|c|c|c|c|}
        \hline
                       & \textbf{\# Name} & \textbf{Langname} & \textbf{\# $\uparrow$ Fach} & \textbf{Stundenzahl min.} & \textbf{Stundenzahl max.} \\ \hline\hline
        \textbf{Data Type} & TEXT & TEXT & TEXT & INTEGER & INTEGER \\
        \textbf{Constraints}& NN, PK & NN & NN, PK, FK & & \\
        \textbf{Checks}    & & & & $\ge 0$ & $\ge 0$ \\ \hline
        \textbf{Notation}  & \cellcolor[HTML]{A4C2F4} PK & & \cellcolor[HTML]{A4C2F4} PK & & \\ \hline
...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|c|c|c|c|}
        ...
        \textbf{Notation}  & \cellcolor[HTML]{A4C2F4} PK & \cellcolor[HTML]{A4C2F4} PK & \cellcolor[HTML]{A4C2F4} PK & \cellcolor[HTML]{A4C2F4} PK & \\ \hline
