...
Wenn die Parallelität jedoch aufgehoben wird, sieht das anders aus. Ein Beispiel für einen solchen Fall ist die zweite Fremdsprache in der Unter- und Mittelstufe.
...
Wenn die betroffene Wahlpflichtveranstaltung eine Übung ist, kann ein alternativer Übungstermin gewählt werden, wenn es eine Vorlesung ist, kann die Veranstaltung gegebenen falls in einem anderen Semester belegt werden.
...
Neben jederzeit parallelen (Wahlpflicht-)Veranstaltungen, die bereits im vorherigen Abschnitt thematisiert wurden, trifft dies auch auf andere Fälle zu, zum Beispiel auf zweiwöchig stattfindenden Nachmittagsunterricht oder nur in einem Halbjahr stattfindenden Veranstaltungen.
Dafür haben wir drei Ursachen \todo{Sind das wirklich nur 3 oder kann ich nicht zählen} identifiziert, die zu solchen Konflikten führen können.
Alle drei Ursachen können auf unterschiedliche Arten behandelt werden, die wir im Folgenden beschreiben werden.
...
\todo{Soll ich das vielleicht ein bisschen Umschreiben? Würde hier auf jeden Fall z.B. auschreiben}
