...
\paragraph*{Jahrgang}
Ein Jahrgang ist eine Menge von Schülern, die im selben Jahr an einer Schule eingeschult wurden. 
Jeder Jahrgang besteht aus mehreren Klassen, die gemeinsam bestimmte Lehrveranstaltungen besuchen und hat eine gewisse Anzahl an Lehrveranstaltungen, die von den Schülern besucht werden müssen.
\paragraph{Oberstufe}
Die Oberstufe ist ein spezieller Jahrgang, der sich aus Schülern zusammensetzt, die sich auf das Abitur vorbereiten. 
...
Die Planung der Lehrveranstaltungen in der Oberstufe erfordert besondere Aufmerksamkeit, da die Schüler unterschiedliche Fächerkombinationen wählen können und somit eine flexible Gestaltung des Stundenplans notwendig ist.
\paragraph{Schuljahr}
...
Druckrubriken dienen der Leserlichkeit Veranstaltungsverzeichnisses. Sie fassen Lehrveranstaltungen unter verschiedenen Rubriken zusammen und stellen so eine baumartige Ordnung her.
%
\todo{Was zum fick ist eine Druckrubrik???}
\paragraph*{Raum}
...
%
\paragraph*{Lehrerperson}
Eine Lehrerperson ist eine von der Schule zum halten von Lehrveranstaltung zur Verfügung gestellte menschliche Ressource.
Jeder Lehrveranstaltung ist genau einer Lehrerperson (es gibt seltene Ausnahmen mit mehreren Lehrerpersonen pro Lehrveranstaltung), % jedoch kann ein*e Lehrer*in mehrere Lehrveranstaltungen anbieten.
Wir werden im folgenden den Begriff "Lehrer" als geschlechtsneutralen Begriff für "Lehrerperson" verwenden.
%
...
Dazu benötigen sie Zugriff auf die Liste der angebotenen Lehrveranstaltungen, um aus dieser die Lehrveranstaltungen auszuwählen, die sie in dem jeweiligen Schuljahr anbieten möchten.
