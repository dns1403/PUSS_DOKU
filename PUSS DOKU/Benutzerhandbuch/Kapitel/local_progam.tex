...
\subsubsection{Benötigte zusätzliche Software}
 ...
 Dabei wird außerdem die Python-Bibliothek \texttt{pandas} benötigt, um die Daten zu verarbeiten\footnote{Die Installation von Pandas hängt vom Betriebssystem ab und kann leicht recherchiert werden.}.
