...
Der Planer die folgenden zwei Möglichkeiten, um die Daten von Untis in das lokale Planungstool zu übertragen:
\begin{itemize}
...
Alternativ kann unter Linux aber auch das Bash-Skript \textbf{untis-to-stulp.sh} ausgeführt werden.
