...
Es gibt auch die Möglichkeit, Konflikte unwiederruflich durch Einträge in der Konfigurationsdatei \texttt{IgnoredConflicts.json} zu ignorieren.
...
\subparagraph{StudiengangLeicht und StudiengangSchwer}

Die Elemente \textit{StudiengangLeicht} und \textit{StudiengangSchwer} enthalten beide jeweils die Unterelemente \textit{KonfliktfreieStudiengaenge} und \textit{ParalleleKurse}, welche jeweils eine Liste enthalten.
...
\subparagraph{AlternierendeKurseProVeranstaltungsteil}

Das Element \texttt{AlternierendeKurseProVeranstaltungsteil} enthält eine Liste von Listen.
